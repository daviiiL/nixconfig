{
  ...
  cfg = config.localHome.programs.browsers.firefox;
  lock-false = {
    Value = false;
    Status = "locked";
  };
...
in {
  options.localHome.programs.browsers.firefox.enable =
    lib.mkEnableOption "firefox browser with hardened defaults";
